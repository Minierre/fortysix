...
describe('stats', () => {
  ...
  it('receives correct statistics from inserting two generation two tasks', () => {
  ...
  it('recieves the correct statistics from add two generation two tasks and one generation three tasks', () => {
